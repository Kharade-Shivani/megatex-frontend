...
function CategoryMaster() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await httpClient.put('/update_Category', { ...categoryData, _id: editingId });
        showSuccessMessage('Category updated successfully!');
      } else {
        // Create new category
        await httpClient.post('/create_category', categoryData);
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmed) {
      try {
        await httpClient.delete(`/delete_Category/${id}`);
